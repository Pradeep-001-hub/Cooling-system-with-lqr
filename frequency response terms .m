...
% Settling time lines
xline(info_lqg.SettlingTime,'b--','LQG Settling')
xline(info_pid.SettlingTime,'--','Color',[0.5 0 0.5],'Label','PID Settling')

grid on
legend('LQG','PID','LQG Peak','PID Peak')
title('LQG vs PID with Overshoot & Settling Time')
xlabel('Time (seconds)')
ylabel('Response')